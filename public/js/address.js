...
function stringToBase64(e) {
  return "undefined" == typeof self
    ? Buffer.from(e, "binary").toString("base64")
    : btoa(e);
}
...
class Address {
  ...
  toString(e, t, s, r) {
    if (
      (void 0 === e && (e = this.isUserFriendly),
      void 0 === t && (t = this.isUrlSafe),
      void 0 === s && (s = this.isBounceable),
      void 0 === r && (r = this.isTestOnly),
      !e)
    )
      return this.wc + ":" + bytesToHex(this.hashPart);
    {
      ...
      let o = stringToBase64(
        String.fromCharCode.apply(null, new Uint8Array(l))
      );
